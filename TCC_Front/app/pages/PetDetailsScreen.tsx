            ...
            try {
                ...
                const getDoencas = async () => {
                    try {
                        ...
                        console.log(`Encontradas ${doencasResponse.length} doenças para o pet ID ${petId}: ${JSON.stringify(doencasResponse)}`);
                            ...
                            onPress={() => {
                                ...
                                const fetchPetDetails = async () => {
                                    try {
                                        ...
                                        try {
                                            const [racaInfo, usuarioInfo, statusInfo, sexoInfo, doencasIds, faixaEtariaInfo] = await Promise.all([
                                                getRacaById(petData.raca_id),
                                                getUsuarioById(petData.usuario_id),
